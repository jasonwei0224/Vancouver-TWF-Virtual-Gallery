  ...
  const myRef3 = useRef(null)
    return (
        ...
        <div id="homeThirdSection">
          ...
          <span  ref ={myRef2} ><HomeColoredHeader2 title="BEHIND THE MASK" image={homepage_placeholder_lg}/></span>
            ...
            <span ref ={myRef3}><HomeColoredHeader2  title="SHARE YOUR PHOTOS" image={homepage_placeholder_lg}/></span>
        ...
        <div id="homeThirdSectionMobile">
            ...
            <HomeMobileProject url="/Sky"type="INTSTALLATION ART" title="SKY" image={sky_mobile} hover={sky_mobile_hover}/>
            ...
            <HomeMobileProject url="/IAmDifferentForm" type="INTERACTIVE" title="WE ARE ALL IN THIS TOGETHER" image={diff2_mobile} hover={diff2_mobile_hover} />
            <HomeMobileProject url="/Sky" type="INTERACTIVE" title="UNDER THE SAME SKY PROJECT" image={sky2_mobile} hover={sky2_mobile_hover}/>
