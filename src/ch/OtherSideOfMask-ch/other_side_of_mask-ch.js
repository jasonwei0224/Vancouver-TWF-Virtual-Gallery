...
class OtherSideOfMask_ch extends Component {
    render() {
        ...
        return (
          ...
          <MaskInfo></MaskInfo>
            <MainContents_TwoArtistPic_CH pic1={ladyhaohao} title1="Lady Hao Hao"contents1={artistTxt1} pic2={walter} title2="高宇翔 / Yani-X" contents2={artistTxt2}></MainContents_TwoArtistPic_CH>
