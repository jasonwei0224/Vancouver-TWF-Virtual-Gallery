...
class SkyV1_ch extends Component {
  ...
  checkValue() {
    ...
    var lastNameLegnth=document.getElementById('lastName').value.length;
  ...
  render() {
    return (
      ...
      <ProgramInfo_ch subtitle="我跟你的相同, 就是我們都不同" title="頭頂同一片天計畫" artistName="台灣文化節" url="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgallery.vancouvertaiwanfest.ca%2F%23%2Fsky-ch&amp;src=sdkpreparse" color="#246f79">
      </ProgramInfo_ch>
      ...
      <MainContents_Middle_ch contents="當數字「8」轉為橫向成為「∞」無限符號，象徵天空的無邊無際、遼闊遠大。膚色、外貌、族裔、語言、文化，不會是限制人類理解彼此的界線；「∞」也象徵愛的永恆，當人們能互相欣賞不一樣的美麗，就能平等地認同彼此的存在價值，共同創造人類永續未來的機會。"></MainContents_Middle_ch>
      <MainContents_Middle_ch contents="在台灣文化節活動期間，不只在溫哥華美術館前廣場能看到八座「天空」燈光裝置藝術作品，陪伴溫哥華人度過黎明與黑夜。即使你人不在溫哥華，甚至不在加拿大，你都可以隨時拍下【中午十二點】的天空照片上傳分享，立即加入我們 ! 在夏天的尾聲，透過看著同一片天空的不同風景，感受不同的空間氛圍，不受地域和時間限制，貼近彼此，相互作伴 !"></MainContents_Middle_ch>
  ...
  <Row className="space"><Col></Col></Row>
    <FormSectionTitle_ch title="攝影師資訊"></FormSectionTitle_ch>
      ...
      <FormConsent_ch inputId="checkbox-3" consent="我同意台灣文化節將我所拍攝的照片作為「頭頂同一片天計畫」節目的內容與相關宣傳使用。"></FormConsent_ch>
        ...
        <ButtonCh onclick={this.submitForm} title="送出" togoUrl="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgallery.vancouvertaiwanfest.ca%2F%23%2Fsky-ch&amp;src=sdkpreparse"></ButtonCh>
