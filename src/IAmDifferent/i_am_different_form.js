  ...
  async uploadFile(file, formInputs) {
    ...
    return (
      <div>
        <Container fluid>
          <Row>
            <Col  xl={{span:12, offset:0}} lg={{ span: 12, offset: 0 }} xs={{ span: 12, offset: 0 }} bsPrefix="image_col">
              <img className="main_image" src={different_img}/>
            </Col>
          </Row>

          <ProgramInfo subtitle="I'm different, just like you !" title="WE ARE ALL IN THIS TOGETHER" artistName="TAIWANfest" url="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgallery.vancouvertaiwanfest.ca%2FIAmDifferentForm&amp;src=sdkpreparse"   color="#246f79"></ProgramInfo>
        ...
        <Form encType="multipart/form-data">
          ...
          {/*}  </Form.Row>*/}
            ...
            <Button1 onclick={this.submitForm} title="SUBMIT" togoUrl="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgallery.vancouvertaiwanfest.ca%2FIAmDifferentForm&amp;src=sdkpreparse"  ></Button1>
