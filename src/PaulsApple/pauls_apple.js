  ...
  return (
    <div>
      <Container fluid style={{padding:"0"}}>
        ...
        <MainContents_Important_With_Border  style={{color:"#0C3866"}} contents="Click and drag the bar in the middle to see the difference."></MainContents_Important_With_Border>
